...
public class Game extends Canvas implements KeyListener {
	...
	public Game(Dimension dim) {
		buffer 	= new BufferedImage(dim.width, dim.height,
                ...
                int randomBatX = randomNo.nextInt(dim.width-50)+50 ; // start the bat in Random X Coordinate
                bat 	= new Bat(dim.width, dim.height, 100, 10, randomBatX, dim.height - 40, 5);
                
                
                int randomBallX = randomNo.nextInt(dim.width-5) ; // start the ball in Random X Coordinate
		ball 	= new Ball(dim.width, dim.height, 10,randomBallX,0, 5,bat);			//>>
